...
`rtc-set` validates the complete Gregorian date before calling the provider. The
...
The module is linked by the EK-RA8P1 and STM32N6570-DK basic diagnostic
consoles. There is no separate RTC-only target firmware.
